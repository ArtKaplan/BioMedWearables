        ...
        ListView(
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.center, 
              children: [Icon(Icons.person_pin_rounded, size: 90,),Text(settings.name, style: Theme.of(context).textTheme.headlineSmall?.copyWith(fontSize: 30), textAlign: TextAlign.left,), ],),
