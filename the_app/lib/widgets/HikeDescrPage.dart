...
class Hikedescrpage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> x_Index =
        hikeStats.map((e) => e['index'].toString()).toList();
    final List<double> y_Duration =
        hikeStats
            .map((e) => (e['duration'] as Duration).inSeconds / 3600)
            .toList(); //convert. from sec to h
    final List<double> y_Diffiulty =
        hikeStats.map((e) {
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: 'Estimated amount of steps : ',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    TextSpan(text: '${hike.distance * 1000 ~/ stepLength}'),
                  ],
                ),
              ),
              RichText(
              ...
              Card(
                ...
                child: Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(
                      'Google Maps route to the starting point',
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text: 'You haven\'t done this hike yet\n',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    TextSpan(text: 'Record your hike to gain insights.'),
                  ],
                ),
              ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text:
                          'Well done! You have done this hike ${hikeStats.length} times already! \n',
                      style: TextStyle(fontWeight: FontWeight.bold),
                    ),
                    //TextSpan(text: 'Well done! You have done this hike ${hike.times.length} times already! \n', style: TextStyle(fontWeight: FontWeight.bold)),
                    TextSpan(
                      text:
                          'Check out your stats for this hike below. How do you like your progress?',
                    ),
                  ],
                ),
              ),
              ...
              Container(
                ...
                child: SimpleBarChart(
                  xAxisList: x_Index,
                  yAxisList: y_Diffiulty,
                  xAxisName: 'Hike #',
                  yAxisName: 'Difficulty',
                  interval: 1,
                ),
